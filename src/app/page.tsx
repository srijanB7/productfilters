...
export default function Home() {
    ...
    const debouncedSubmit = useCallback(debounce(onSubmit, 200), []);
    const applyArrayFilter = ({
        ...
        if (filter[category].includes(value as never)) {
            setFilter({
                ...filter,
                [category]: filter[category].filter((val) => val !== value),
            });
        } else {
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                    ...
                    <ul className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                        {products && products.length === 0 ? (
                            ...
                            new Array(12)
                                .fill(null)
                                .map((_, ind) => <ProductSkeleton key={ind} />)
                        )}
                    </ul>
                </div>
            </section>
